...
urlpatterns = [
    ...
    # Coordinadora
    path('coordinadora/dashboard/', views.dashboard_coordinadora, name='coordinadora_dashboard'),
    
    # Tutores (vistas de templates)
    path('tutores/', include(('apps.tutores.urls', 'tutores'), namespace='tutores_web')),
    
    # Encuestas (vistas de templates)
    path('encuestas/', include(('apps.encuestas.urls', 'encuestas'), namespace='encuestas_web')),
    ...
    path('api/tutores/', include(('apps.tutores.urls', 'tutores'), namespace='tutores_api')),
    path('api/encuestas/', include(('apps.encuestas.urls', 'encuestas'), namespace='encuestas_api')),
    ...
    path('api/', include('apps.reuniones.urls')),
